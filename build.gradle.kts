...
subprojects {
  ...
  dependencies {
    ...
    implementation("com.azure.spring:spring-cloud-azure-starter-storage-blob:5.13.0")
    implementation("com.azure.spring:spring-cloud-azure-starter-storage:5.13.0")
