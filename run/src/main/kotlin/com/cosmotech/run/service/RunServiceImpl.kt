...
class RunServiceImpl(
  ...
  override fun getRuns(
    ...
    val runner = runnerApiService.findRunner(organizationId, workspaceId, runnerId)
  ...
  fun onRunStop(runStopRequest: RunStop) {
    val run = runStopRequest.runData as Run
  ...
  private fun Run.hasPermission(permission: String) {
    val runner =
        runnerApiService.findRunner(this.organizationId!!, this.workspaceId!!, this.runnerId!!)
