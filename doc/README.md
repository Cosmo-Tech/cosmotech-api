...
*ScenariorunresultsApi* | [**createScenarioRunResults**](Apis/ScenariorunresultsApi.md#createscenariorunresults) | **POST** /organizations/{organization_id}/workspace/{workspace_id}/scenario/{scenario_id}/scenariorun/{scenariorun_id}/scenariorunresults/{scenariorunresults_id} | Create a new ScenarioRunResult in the Organization
*ScenariorunresultsApi* | [**getScenarioRunResults**](Apis/ScenariorunresultsApi.md#getscenariorunresults) | **GET** /organizations/{organization_id}/workspace/{workspace_id}/scenario/{scenario_id}/scenariorun/{scenariorun_id}/scenariorunresults/{scenariorunresults_id} | Get a ScenarioRunResult in the Organization
