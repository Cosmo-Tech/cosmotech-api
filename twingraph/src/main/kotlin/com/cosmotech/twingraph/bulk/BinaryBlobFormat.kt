...
data class HeaderBinaryBlobFormat(private val name: String, private val propertyCount: UInt, private val propertyNames: List<String>) {
...
data class EdgeBinaryBlobFormat(val source: Long, val target: Long, val properties: List<PropertyBinaryBlobFormat>) {
    var binary: ByteArray = byteArrayOf()
    var size: Int = 0
