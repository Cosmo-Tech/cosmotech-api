...
class SolutionServiceIntegrationTest : CsmTestBase() {
  ...
  private val logger = LoggerFactory.getLogger(SolutionServiceIntegrationTest::class.java)
    ...
    val SOLUTION_ID_MUST_NOT_BE_BLANK = "Solution Id must not be blank"
  ...
  fun `assert timestamps are functional for RBAC CRUD`() {
    ...
    @Test
    fun `test createSolution with empty ids`() {
    ...
    @Test
    fun `test createSolutionAccessControl with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.createSolutionAccessControl("", solutionSaved.id,
                SolutionAccessControl(id="test", role="role"))
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.createSolutionAccessControl(organizationSaved.id, "",
                SolutionAccessControl(id="test", role="role"))
        }

        assertEquals(SOLUTION_ID_MUST_NOT_BE_BLANK, exception.message)
    }

    @Test
    fun `test createSolutionParameter with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.createSolutionParameter("", solutionSaved.id,
                RunTemplateParameterCreateRequest(id="test", varType="varType"))
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.createSolutionParameter(organizationSaved.id, "",
                RunTemplateParameterCreateRequest(id="test", varType="varType"))
        }
    ...
    @Test
    fun `test createSolutionParameterGroup with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.createSolutionParameterGroup("", solutionSaved.id,
                RunTemplateParameterGroupCreateRequest(id="test"))
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.createSolutionParameterGroup(organizationSaved.id, "",
                RunTemplateParameterGroupCreateRequest(id="test"))
        }
    ...
    @Test
    fun `test createSolutionRunTemplate with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.createSolutionRunTemplate("", solutionSaved.id,
                RunTemplateCreateRequest(id="test"))
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.createSolutionRunTemplate(organizationSaved.id, "",
                RunTemplateCreateRequest(id="test"))
        }
    ...
    @Test
    fun `test deleteSolution with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.deleteSolution("",solutionSaved.id)
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.deleteSolution(organizationSaved.id,"")
        }
    ...
    @Test
    fun `test deleteSolutionAccessControl with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.deleteSolutionAccessControl("",solutionSaved.id, "identityId")
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.deleteSolutionAccessControl(organizationSaved.id,"", "identityId")
        }
    ...
    @Test
    fun `test deleteSolutionParameter with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.deleteSolutionParameter("",solutionSaved.id, "paramId")
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.deleteSolutionParameter(organizationSaved.id,"", "paramId")
        }
    ...
    @Test
    fun `test deleteSolutionParameterGroup with empty ids`() {
        ...
        exception = assertThrows<IllegalStateException> {
            solutionApiService.deleteSolutionParameterGroup(organizationSaved.id,
                "",
                "paramGroupId")
        }
    ...
    @Test
    fun `test deleteSolutionRunTemplate with empty ids`() {
        ...
        exception = assertThrows<IllegalStateException> {
            solutionApiService.deleteSolutionRunTemplate(organizationSaved.id,
                "",
                "runTemplateId")
        }
    ...
    @Test
    fun `test getRunTemplate with empty ids`() {
        ...
        exception = assertThrows<IllegalStateException> {
            solutionApiService.getRunTemplate(organizationSaved.id,
                "",
                "runTemplateId")
        }
    ...
    @Test
    fun `test getSolution with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.getSolution("",
                solutionSaved.id)
        }
        ...
        exception = assertThrows<IllegalStateException> {
            solutionApiService.getSolution(organizationSaved.id,
                "")
        }
    ...
    @Test
    fun `test getSolutionAccessControl with empty ids`() {
        ...
        exception = assertThrows<IllegalStateException> {
            solutionApiService.getSolutionAccessControl(organizationSaved.id,
                "",
                "identityId")
        }
    ...
    @Test
    fun `test getSolutionParameter with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.getSolutionParameter("",solutionSaved.id, "paramId")
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.getSolutionParameter(organizationSaved.id,"", "paramId")
        }
    ...
    @Test
    fun `test getSolutionParameterGroup with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.getSolutionParameterGroup("",solutionSaved.id, "paramGroupId")
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.getSolutionParameterGroup(organizationSaved.id,"", "paramGroupId")
        }
    ...
    @Test
    fun `test getSolutionSecurity with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.getSolutionSecurity("",solutionSaved.id)
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.getSolutionSecurity(organizationSaved.id,"")
        }
    ...
    @Test
    fun `test listRunTemplates with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.listRunTemplates("",solutionSaved.id)
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.listRunTemplates(organizationSaved.id,"")
        }
    ...
    @Test
    fun `test listSolutionParameterGroups with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.listSolutionParameterGroups("",solutionSaved.id)
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.listSolutionParameterGroups(organizationSaved.id,"")
        }
    ...
    @Test
    fun `test listSolutionParameters with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.listSolutionParameters("",solutionSaved.id)
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.listSolutionParameters(organizationSaved.id,"")
        }
    ...
    @Test
    fun `test listSolutionSecurityUsers with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.listSolutionSecurityUsers("",solutionSaved.id)
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.listSolutionSecurityUsers(organizationSaved.id,"")
        }
    ...
    @Test
    fun `test listSolutions with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.listSolutions("",null,null)
        }
    ...
    @Test
    fun `test updateSolution with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolution("",solutionSaved.id,
                SolutionUpdateRequest())
        }
        ...
        exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolution(organizationSaved.id,"",
                SolutionUpdateRequest())
        }
    ...
    @Test
    fun `test updateSolutionAccessControl with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionAccessControl("",solutionSaved.id,
                "identityId",SolutionRole("role"))
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionAccessControl(organizationSaved.id,"",
                "identityId",SolutionRole("role"))
        }
    ...
    @Test
    fun `test updateSolutionDefaultSecurity with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionDefaultSecurity("",solutionSaved.id,
                SolutionRole("role"))
        }
        ...
        exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionDefaultSecurity(organizationSaved.id,"",
                SolutionRole("role"))
        }
    ...
    @Test
    fun `test updateSolutionParameter with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionParameter("",solutionSaved.id,
                "paramId",RunTemplateParameterUpdateRequest())
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionParameter(organizationSaved.id,"",
                "paramId",RunTemplateParameterUpdateRequest())
        }
    ...
    @Test
    fun `test updateSolutionParameterGroup with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionParameterGroup("",solutionSaved.id,
                "parameterGroupId",RunTemplateParameterGroupUpdateRequest())
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionParameterGroup(organizationSaved.id,"",
                "parameterGroupId",RunTemplateParameterGroupUpdateRequest())
        }
    ...
    @Test
    fun `test updateSolutionRunTemplate with empty ids`() {

        var exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionRunTemplate("",solutionSaved.id,
                "runTemplateId",RunTemplateUpdateRequest())
        }

        assertEquals(ORGANIZATION_ID_MUST_NOT_BE_BLANK, exception.message)

        exception = assertThrows<IllegalStateException> {
            solutionApiService.updateSolutionRunTemplate(organizationSaved.id,"",
                "runTemplateId",RunTemplateUpdateRequest())
        }
