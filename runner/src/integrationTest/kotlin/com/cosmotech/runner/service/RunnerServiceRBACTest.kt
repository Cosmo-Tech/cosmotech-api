          ...
          .map { (role, shouldThrow) ->
            dynamicTest("Test Runner RBAC.findRunner : $role") {
              ...
              if (shouldThrow) {
                ...
                assertEquals(
                    "RBAC ${runnerSaved.id} - Entity does not have permission $PERMISSION_READ",
                    exception.message)
              } else {
                assertDoesNotThrow {
                  runnerApiService.getRunner(
            ...
            dynamicTest("Test Runner RBAC updateRunner : $role") {
              ...
              if (shouldThrow) {
                ...
                if (role == ROLE_NONE) {
                  ...
                  assertEquals(
                      "RBAC ${runnerSaved.id} - Entity does not have permission $PERMISSION_WRITE",
                      exception.message)
                }
              } else {
                assertDoesNotThrow {
            ...
            dynamicTest("Test Runner RBAC listRunnerPermissions : $role") {
              ...
              if (shouldThrow) {
                ...
                if (role == ROLE_NONE) {
                  ...
                  assertEquals(
                      "RBAC ${runnerSaved.id} - Entity does not have permission $PERMISSION_READ_SECURITY",
                      exception.message)
                }
              } else {
                assertDoesNotThrow {
            ...
            dynamicTest("Test Runner RBAC updateRunnerDefaultSecurity : $role") {
              ...
              if (shouldThrow) {
                ...
                if (role == ROLE_NONE) {
                  ...
                  assertEquals(
                      "RBAC ${runnerSaved.id} - Entity does not have permission $PERMISSION_WRITE_SECURITY",
                      exception.message)
                }
              } else {
                assertDoesNotThrow {
