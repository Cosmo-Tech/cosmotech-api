...
object OrganizationConstants {
  ...
  object RequestContent {
    ...
    const val ORGANIZATION_REQUEST_CREATION_WITH_ACCESSES =
        """{"name":"$ORGANIZATION_NAME","security":{"default":"$ROLE_NONE","accessControlList":[{"id":"$PLATFORM_ADMIN_EMAIL", "role":"$ROLE_ADMIN"},{"id":"$NEW_USER_ID", "role":"$NEW_USER_ROLE"}] }}"""
    ...
    const val MINIMAL_ORGANIZATION_ACCESS_CONTROL_REQUEST =
