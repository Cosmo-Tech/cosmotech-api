...
class WorkspaceControllerTests : ControllerTestBase() {
    ...
    fun create_workspace() {
        ...
        val defaultRunTemplateDataset = mutableMapOf<String, Any>("runtemplateId1" to "datasetId1","runtemplateId2" to "datasetId2")
        val iframes = mutableMapOf("you_can_put" to "whatever_you_want_here",
            "even" to JSONObject(mapOf("object" to "if_you_want")))
        val options = mutableMapOf("you_can_put" to "whatever_you_want_here",
            "even" to JSONObject(mapOf("object" to "if_you_want")))
        val workspaceSecurity = WorkspaceSecurity(default = ROLE_NONE,
        ...
        mvc
            .perform(
                post("/organizations/$organizationId/workspaces")
                    ...
                    .content(
                        JSONObject(constructWorkspaceCreateRequest(
                            WORKSPACE_KEY,
                            WORKSPACE_NAME,
                            solutionId,
                            description,
            ...
            .andExpect(jsonPath("$.solution.defaultRunTemplateDataset").value(defaultRunTemplateDataset))
    ...
    fun update_workspace() {
        ...
        val workspaceId = createWorkspaceAndReturnId(mvc,organizationId, WORKSPACE_KEY, WORKSPACE_NAME, solutionId)
        ...
        mvc
            .perform(
                patch("/organizations/$organizationId/workspaces/$workspaceId")
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(
                        JSONObject(constructWorkspaceUpdateRequest(
                            WORKSPACE_KEY,
                            WORKSPACE_NAME,
                            solutionId,
                            description,
    ...
    fun list_workspaces() {
        ...
        val firstWorkspaceId = createWorkspaceAndReturnId(mvc,
            organizationId,
        ...
        val secondWorkspaceId = createWorkspaceAndReturnId(mvc,
            organizationId,
            constructWorkspaceCreateRequest(
    ...
    fun get_workspace() {
        ...
        val workspaceId = createWorkspaceAndReturnId(mvc,organizationId,
            constructWorkspaceCreateRequest(
            WORKSPACE_KEY,
            WORKSPACE_NAME,
            solutionId,
    ...
    fun delete_workspace() {
        ...
        val workspaceId = createWorkspaceAndReturnId(mvc,organizationId, WORKSPACE_KEY,
            WORKSPACE_NAME,solutionId)
    ...
    fun add_workspace_security_access() {
        ...
        mvc
            ...
            .andDo(MockMvcResultHandlers.print())
            .andDo(document("organizations/{organization_id}/workspaces/{workspace_id}/security/access/POST"))
    }
    ...
    fun get_workspace_security_access() {
        ...
        mvc
            ...
            .andDo(MockMvcResultHandlers.print())
            .andDo(document("organizations/{organization_id}/workspaces/{workspace_id}/security/access/{identity_id}/GET"))
    }
    ...
    fun update_workspace_security_access() {
        ...
        mvc
            .perform(
                patch("/organizations/$organizationId/workspaces/$workspaceId/security/access/$NEW_USER_ID")
                    .contentType(MediaType.APPLICATION_JSON)
            ...
            .andExpect(jsonPath("$.id").value(NEW_USER_ID))
            .andDo(MockMvcResultHandlers.print())
            .andDo(document("organizations/{organization_id}/workspaces/{workspace_id}/security/access/{identity_id}/PATCH"))
    }
    ...
    fun delete_workspace_security_access() {
        ...
        mvc
            .perform(
                delete("/organizations/$organizationId/workspaces/$workspaceId/security/access/$NEW_USER_ID")
                    .with(csrf())
            )
            .andExpect(status().is2xxSuccessful)
            .andDo(MockMvcResultHandlers.print())
            .andDo(document("organizations/{organization_id}/workspaces/{workspace_id}/security/access/{identity_id}/DELETE"))
    }
    ...
    fun update_workspace_security_default() {
        ...
        mvc
            ...
            .andExpect(jsonPath("$.accessControlList[0].role").value(ROLE_ADMIN))
            .andDo(MockMvcResultHandlers.print())
            .andDo(document("organizations/{organization_id}/workspaces/{workspace_id}/security/default/POST"))
    }
    ...
    fun list_workspace_users() {
        ...
        mvc
            ...
            .andDo(MockMvcResultHandlers.print())
            .andDo(document("organizations/{organization_id}/workspaces/{workspace_id}/security/users/GET"))
    }
