...
class WorkspaceControllerTests : ControllerTestBase() {
  ...
  fun list_workspaces() {
    ...
    mvc.perform(
        ...
        .andExpect(jsonPath("$[0].solution.datasetId").doesNotExist())
        .andExpect(jsonPath("$[0].solution.defaultParameterValues").doesNotExist())
        ...
        .andExpect(jsonPath("$[1].solution.datasetId").doesNotExist())
        .andExpect(jsonPath("$[1].solution.defaultParameterValues").doesNotExist())
